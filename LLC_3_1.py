...
class Battery:
	...
	stages:		Array of Stage objects (0 -- stage_num-1). Organic inlet to stages[0] -- Stage 1.
        Oin_list:       List of organic phase mass inlet flows for stages.
        Ain_list:       List of aqueous phase mass inlet flow.
        yin_list:       List of lists of organic phase inlet concentrations: [stage, component]
        xin_list:       List of lists of aqueous phase inlet concentrations.
        Oout_list:      List of organic phase mass outlet flow.
        Aout_list:      List of aqueous phase mass outlet flow.
        yout_list:      List of lists of organic phase outlet concentrations.
        xout_list:      List of lists of aqueous phase outlet concentrations.
        runs:           Number of iterations.
        eff:		Stage efficiency (0.0-1.0).
        errors:         Numpy array of errors.
        Kclass:         Object class for calculating K values. Kclass(x).K returns list of Ks.
