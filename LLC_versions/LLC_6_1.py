...
class CounterCurrentBattery:
    ...
    def __init__(self, stages_num, Oin, Ain, yin, xin, EQUIL, method='successive', damping=1, eff=1., stage_solver_type='custom', max_iter=100, entrainment_perc_in=0, entrainment_comp_in=0, entrainment_perc_out=0, battery_convergence=1e-3, stage_convergence=1E-2, convergence=None, **kwargs):
        """
        ...
        Parameters:
            ...
            stage_solver_type: Stage solver type ('custom' (default) -- manual secant, 'fsolve' -- scipy.optimize.fsolve).
        ...
        self.EQUIL = EQUIL
        self.eff = eff
        self.stage_solver_type = stage_solver_type
    ...
    def calculate_stage(self, stage_idx, flows_comps, stage_convergence):
        ...
        stage = Stage(
            ...
            solver_type=self.stage_solver_type,
